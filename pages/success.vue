  ...
  <div>
          ...
          <div class="row align-items-center">
            <div class="align">
              <div>
                ...
                <div>
                  <h2>
                    ...
                    <small>Satisfactoriamente.</small>
                  </h2>
                  <p class="font">
                    Numero de transacción ID:
                    <span class="font-weight-bold">{{ order['.key'] }}</span>
                  </p>
                  <h4>
                  Recibirá un mensaje o una llamada con respecto a la confirmación del producto.
                  </h4>
                  <h5>
                    <strong>Nota: </strong>Su pedido le será enviado generalmente dentro de 1 hora.
                  </h5>
                </div>
              ...
              <div>
                <div class="products ">
                  <div class="margin">
                    <span class="order_header"> RESUMEN DE PEDIDO</span>
                  </div>
                  <nuxt-link
                    class="product"
                ...
                <h6>
                  <u>Para servicio al cliente</u><br />
                  Por favor contactanos al:<router-link class="cursor" to="">
                    Jender@enksa.com</router-link
                  >
                </h6>
              </div>
            </div>
    ...
    <div class="btn_align1 footer">
      <a type class="btn btn-block btn-white1 btn-lg btncontent">
        ...
        <router-link to="/" class="btnclr">Ver catalogo</router-link>
      </a>
    </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5f32fbc81e6c0725256068a8/default';
s1.charset='UTF-8';
